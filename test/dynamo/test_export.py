...
def forward(self, x):
    ...
    def test_export_module_specify_constraints_signature(self):
        ...
        with self.assertRaisesRegex(
            ConstraintViolationError, "dimx = None  # 3"
        ):
    ...
    def test_export_preserve_constraints_as_metadata_scalar(self):
        ...
        constraints = torch.export.dynamic_shapes._process_dynamic_shapes(f, example_inputs, dynamic_shapes=dynamic_shapes)
        self.assertEqual(
    ...
    def test_export_dynamic_dim_not_1(self):
        ...
        with self.assertRaises(ConstraintViolationError):
            torch._dynamo.export(my_dyn_fn, dynamic_shapes=({0: torch.export.Dim("dimx")},))(x)
    ...
    def test_export_mark_dynamic_conflict_dynamic_dim(self):
        ...
        with self.assertRaisesRegex(
            ...
            torch._dynamo.export(my_dyn_fn, dynamic_shapes=({0: torch.export.Dim("dim")},))(y)
