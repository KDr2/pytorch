...
class TestFullCat(torch.nn.Module):
    def __init__(self) -> None:
        super().__init__()

    def forward(self, x: torch.Tensor):
        full = torch.ops.aten.full.default(
            [4096, 128], 0, dtype = torch.float32, layout = torch.strided, device = x.device, pin_memory = False
        )
        ...
        cat = torch.ops.aten.cat.default(
            [
                ...
                full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full,
                full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full,
                full, full, full, full, full, slice_14, full, slice_15, slice_16, full, full, full, full, full, slice_17, full,
                full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full,
                full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full,
                full, full, full, full, full, slice_18, slice_19, slice_20, slice_21, slice_22, slice_23, full, full, full,
                full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full,
                full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full,
                full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full,
                full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full, full,
...
class TestSplitCatAten(TestCase):
    ...
    def test_full_cat_post_grad(self):
        counters.clear()
        inputs = [
