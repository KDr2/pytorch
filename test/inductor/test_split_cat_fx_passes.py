...
class TestSplitCatFxPasses(TestCase):
    ...
    def test_split_cat_new_patterns(self):
        ...
        def optimize_cat_inputs(x):
            ...
            x_c_2 = x.clone()
            l1_out = torch.split(
                x, [50, 50, 50, 50, 50, 50, 50, 50, 50, 50], dim=0
            )
            l2_out = torch.split(
                x_c, [50, 50, 50, 50, 50, 50, 50, 50, 50, 50], dim=0
            )
        ...
        for fn, expected_getitem_cat_merged, expected_cat_removed, expected_cat_optimized in [
