...
class TestMaxAutotune(TestCase):
    ...
    def test_deferred_layout_constraint_cat_fusion(self):
        ...
        m = 512
        k1, k2 = 256, 256
        n = 1490  # Triggers padding (1490 -> 1536)
