...
class TestMaxAutotune(TestCase):
    ...
    def test_max_autotune_decompose_k(self, sizes, dtype, dynamic):
        fp16_red_setting = torch.backends.cuda.matmul.allow_fp16_reduced_precision_reduction
        bf16_red_setting = torch.backends.cuda.matmul.allow_bf16_reduced_precision_reduction
        torch.backends.cuda.matmul.allow_fp16_reduced_precision_reduction = False
        ...
        torch.backends.cuda.matmul.allow_fp16_reduced_precision_reduction = fp16_red_setting
        torch.backends.cuda.matmul.allow_bf16_reduced_precision_reduction = bf16_red_setting
