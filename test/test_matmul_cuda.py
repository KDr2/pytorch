...
class TestMatmulCuda(TestCase):
    ...
    def test_cublas_baddbmm_large_input(self, device, batch_size, N, M, P, dtype):
        ...
        # M1 = M1.expand(batch_size, N, M)
        # M2 = M2.expand(batch_size, M, P)
        # A = A.expand(batch_size, N, P)
        # M1_cpu = M1_cpu.expand(batch_size, N, M)
        # M2_cpu = M2_cpu.expand(batch_size, M, P)
        # A_cpu = A_cpu.expand(batch_size, N, P)
