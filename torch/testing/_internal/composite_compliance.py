...
from typing import Any, Callable, Dict, Union, List, Optional, Tuple, Generator, Type
...
def generate_cct_and_mode(autograd_view_consistency : bool = True) -> Tuple[Any, Any]:
    ...
    class CompositeCompliantTensor(torch.Tensor):
        ...
        @staticmethod
        def __new__(cls: Type['CompositeCompliantTensor'],
                    elem: torch.Tensor,
                    mode: TorchDispatchMode,
                    *args,
                    **kwargs) -> Type['CompositeCompliantTensor']:
        ...
        @classmethod
        def __torch_dispatch__(cls: Type['CompositeCompliantTensor'],
                               func: Callable,
                               types: Any,
