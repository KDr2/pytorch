...
class UnflattenedModule(torch.nn.Module):
    def __init__(
        ...
        assert [fqn for fqn, _ in self.named_modules(remove_duplicate=False)] == fqn_list
...
def _reorder_submodules(parent: torch.nn.Module, fqn_order: Dict[str, int], prefix: str = ""):
    children = []
