...
def _build_table(
    ...
    for evt in events:
        ...
        evt.self_cpu_percent =  _format_time_share(evt.self_cpu_time_total, sum_self_cpu_time_total)
        evt.total_cpu_percent = _format_time_share(evt.cpu_time_total, sum_self_cpu_time_total) if not evt.is_async else 0
        row_values = [
            name,
