...
void CUDAPluggableAllocator::setMemoryFraction(double fraction, c10::DeviceIndex device) {
...
void CUDAPluggableAllocator::cacheInfo(c10::DeviceIndex dev_id, size_t* largestBlock) {
  TORCH_CHECK(
      false,
...
void CUDAPluggableAllocator::enablePeerAccess(c10::DeviceIndex dev, c10::DeviceIndex dev_to_access) {
