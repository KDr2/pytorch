...
def register_dataclass(
    ...
    *,
    ...
    Args:
        ...
        in.
        field_names (Optional[List[str]]): Attributes which will be treated as
            non-constants. This argument is optional if ``cls`` is a dataclass,
            in which case the fields will be taken from
            ``dataclasses.fields()``.
    ...
    if not dataclasses.is_dataclass(cls):
        assert field_names is not None, (
            "field_names must be specified with a list of non-constant"
