...
class TorchFunctionModeVariable(GenericContextWrappingVariable):
    ...
    def __init__(self, value: Optional[Any], source: Optional[Source]=None, **kwargs: Any):
    ...
    def call_torch_function(self, tx: "InstructionTranslator", fn: Any, types: Any, args: Any, kwargs: Any) -> Any:
...
class SymbolicTorchFunctionState:
    ...
    def call_torch_function_mode(self, tx: InstructionTranslator, fn: Callable[[Any], Any], types: Any, args: Any, kwargs: Any) -> Any:
        with self._pop_mode_for_inlining() as cur_mode:
            return cur_mode.call_torch_function(tx, fn, types, args, kwargs)

    @contextlib.contextmanager
    def _pop_mode_for_inlining(self) -> Generator[TorchFunctionModeVariable, None, None]:
...
def _get_all_args(args: Any, kwargs: Any) -> Iterable[VariableTracker]:
...
def _get_subclass_type_var(tx: "InstructionTranslator", var: VariableTracker) -> VariableTracker:
...
def _is_attr_overridden(tx: "InstructionTranslator", var: VariableTracker, name: str) -> bool:
...
def call_torch_function(tx: "InstructionTranslator", torch_function_var: Any, fn: Any, types: Any, args: Any, kwargs: Any) -> Any:
...
def can_dispatch_torch_function(tx: "InstructionTranslator", args: Any, kwargs: Any) -> bool:
...
def dispatch_torch_function(tx: "InstructionTranslator", fn: Any, args: Any, kwargs: Any) -> Any:
...
class TensorWithTFOverrideVariable(TensorVariable):
    ...
    @classmethod
    def from_tensor_var(cls, tx: "InstructionTranslator", tensor_var: VariableTracker, class_type: Any, cls_source: Any) -> "TensorWithTFOverrideVariable":
