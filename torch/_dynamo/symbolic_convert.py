...
class InstructionTranslatorBase(
    ...
    def prune_dead_locals(self):
        ...
        # First prune the non-cell local vars, this allows us to prune more cell
        # local vars later on (e.g., if we manage to prune a
        ...
        if self.output.side_effects.is_empty():
            ...
            VariableTracker.visit(
                visit, (local_non_cell_vars, self.stack, self.output.backward_state)
            )
