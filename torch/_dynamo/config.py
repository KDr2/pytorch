...
from typing import Any, Callable, Optional, TYPE_CHECKING, Union, Literal
...
# no optimization.
optimize_ddp: Union[bool, Literal["ddp_optimizer", "python_reducer", "python_reducer_without_compiled_forward", "no_optimization"]] = True
