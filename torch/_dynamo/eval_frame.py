...
def _log_traced_frames():
    ...
    """
    msg = "TorchDynamo attempted to trace the following frames: ["
    if len(dynamo_tls.traced_frame_infos) > 0:
        msg += "\n"
        for traced_frame_info in dynamo_tls.traced_frame_infos:
            msg += "  * " + traced_frame_info + "\n"
    msg += "]"
    log.info(msg)
