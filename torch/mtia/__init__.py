...
def seed_all() -> int:
    ...
    .. warning::
        The returned seed is the seed value used for the first device. Since each device
        will be seeded independently, the seeds will be different for different devices.
    """
    ...
    def cb():
        ...
        for i in range(device_count()):
            default_generator = default_generators[i]
            seed_val = default_generator.seed()
