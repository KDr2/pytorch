...
aot_autograd_decompositions: dict[Any, Any] = {}
...
def aot_function(
    ...
    *,
    ...
    @wraps(fn)
    def returned_function(*args: Any, **kwargs: Any) -> Any:
        nonlocal cached_res
...
def prepare_aot_module_simplified(
    ...
    decompositions: dict[Any, Any] | None,
...
def aot_module_simplified(
    ...
    partition_fn: Callable[..., Any] = default_partition,
    decompositions: dict[Any, Any] | None = None,
    keep_inference_input_mutations: bool = False,
...
def boxed_nop_preserve_node_meta(
    fx_g: torch.fx.GraphModule, example_inputs: Sequence[Any]
) -> Any:
...
def aot_compile_joint_with_descriptors(
    ...
    *,
    partition_fn: Callable[..., Any] = default_partition,
    fw_compiler: Callable[..., OutputCode] = boxed_nop_preserve_node_meta,
    bw_compiler: Callable[..., Any] | None = boxed_nop_preserve_node_meta,
