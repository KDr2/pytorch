...
CustomRuntimeEstimatorType: TypeAlias = Optional[
    Union[CustomRuntimeEstimator, str]
]

CustomKnapsackSolverType: TypeAlias = Optional[
    Union[CustomKnapsackSolver, str]
]
