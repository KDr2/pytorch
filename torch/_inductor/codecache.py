...
class PersistentCache:
    def __init__(self):
        ...
        if torch.cuda.is_available():
            self.dinfo = repr(torch.cuda.get_device_properties(torch.cuda.current_device()))
    ...
    def lookup(self, choices, name: str, key: str, generator: Callable[[Any], Tuple[Dict, bool]]):
        """
        ...
        for choice in choices:
            ...
            if name in global_cache and key in global_cache[name] and choice_hash in global_cache[name][key]:
