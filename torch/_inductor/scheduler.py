...
class Scheduler:
    ...
    ) -> Union[bool, tuple[Callable[[], bool], Optional[LambdaFuture]]]:
        """
    ...
    def fuse_nodes_once(
        ...
        def resolve_pending_fusions(
            ...
            while (
                ...
                fusion_log.error(
                    f"Evaluate {node1.get_name()} {node2.get_name()} in pending_fusions"
                )
