    ...
    def fuse_nodes_once(
        ...
        def evaluate_pending_template_fusions(
            ...
            def fuse_if_speedup(node1, node2, speedup_fn):
                if self.can_fuse(node1, node2) and speedup_fn() and not self.will_fusion_create_cycle(node1, node2):
            ...
            while len(fusion_nodes) > len(finished_fusions):
                ...
                for f in as_completed(template_futures):
                    ...
                    fuse_if_speedup(self.get_fused_node(node1), self.get_fused_node(node2), speedup_fn)
