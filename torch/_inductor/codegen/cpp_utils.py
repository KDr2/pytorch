...
class LocalBufferContext:
    ...
    def __init__(self, kernel_args: KernelArgs, in_microgemm: bool=False, inner_layouts: Optional[dict[str, ir.FixedLayout]] = None, inner_names: Optional[set[str]] = None) -> None:
