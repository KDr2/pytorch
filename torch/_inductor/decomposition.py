...
def addmm(input, mat1, mat2, *, beta=1, alpha=1):
    ...
    if (
        ...
        if m_padded_length != 0 or k_padded_length != 0 or n_padded_length != 0:
            return pad_addmm(input, mat1, mat2, m_padded_length, n_padded_length, k_padded_length)
...
def should_pad_bench(mat1, mat2, op, input=None):
    ...
    with no_dispatch():
        ...
        if op is torch.ops.aten.addmm:
            ...
            pad_time = do_bench(
                lambda: pad_addmm(input_pad, mat1_pad, mat2_pad, m_padded_length, k_padded_length, n_padded_length),
                warmup=warmup,
                rep=rep,
                fast_flush=True,
            )[0]
            ...
            pad_time = do_bench(
                lambda: pad_mm(mat1_pad, mat2_pad, m_padded_length, k_padded_length, n_padded_length),
                warmup=warmup,
                rep=rep,
                fast_flush=True,
            )[0]
