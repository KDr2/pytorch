...
def _dump_launch_params(args, kwargs, launcher, kernel_name):
    ...
    call_kwargs["num_consumer_groups"] = launcher.config.num_consumer_groups
    call_kwargs["num_buffers_warp_spec"] = launcher.config.num_buffers_warp_spec
    args_str = ""
...
class CachingAutotuner(KernelInterface):
    ...
    def _precompile_config(self, cfg: Config) -> TritonCompileResult:
        ...
        compile_meta["num_consumer_groups"] = cfg.num_consumer_groups
        compile_meta["num_buffers_warp_spec"] = cfg.num_buffers_warp_spec
