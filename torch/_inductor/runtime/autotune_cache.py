...
class AutotuneCache:
    ...
    @staticmethod
    def create(
        inductor_meta: _InductorMeta, filename: str, configs_hash: str
    ...
    def _read(self, inductor_meta: _InductorMeta) -> Optional[Dict[str, JsonDataTy]]:
    ...
    def read_best(
        self, inductor_meta: _InductorMeta, configs: List[Config]
    ) -> Optional[Config]:
    ...
    def _setup_local_cache(self, inductor_meta: _InductorMeta, filename: str) -> None:
    ...
    def _setup_remote_autotune_cache(
        self, inductor_meta: _InductorMeta, filename: str
    ) -> None:
