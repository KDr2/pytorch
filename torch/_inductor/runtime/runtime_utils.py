...
def do_bench_gpu(fn, warmup=25, rep=100):
    ...
    estimate_ms = min(map(lambda event_pair: event_pair[0].elapsed_time(event_pair[1]), event_pairs))
    ...
    timing = min(map(lambda event_pair: event_pair[0].elapsed_time(event_pair[1]), event_pairs))
    return timing
