...
def _recursive_post_grad_passes(
    ...
    post_grad_passes(gm, is_inference, example_inputs=example_inputs, fake_mode=fake_mode)
...
def fx_codegen_and_compile(
    ...
    with dynamo_utils.preserve_rng_state():
        ...
        with V.set_fake_mode(fake_mode):
            ...
            _recursive_post_grad_passes(gm, is_inference=is_inference, example_inputs=example_inputs, fake_mode=fake_mode)
