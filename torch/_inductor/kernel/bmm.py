...
def tuned_bmm(mat1, mat2, *, layout=None):
    ...
    counters["inductor"][("aten.bmm",(m, n, k))] = counters["inductor"].get(("aten.bmm",(m, n, k)), 0) + 1
    log.info(
...
def tuned_baddbmm(inp, mat1, mat2, *, alpha=1, beta=1, layout=None):
    ...
    # below is for getting an overview logging info of inductor mms
    counters["inductor"][("aten.baddbmm",(m, n, k))] = counters["inductor"].get(("aten.baddbmm",(m, n, k)), 0) + 1
    log.info(
