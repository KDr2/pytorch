...
def tuned_mm(mat1, mat2, *, layout=None):
    ...
    log.info("Tuned aten.mm: m=%s, n=%s, k=%s, layout=%s", m, n, k, layout)
...
def tuned_int_mm(mat1, mat2, *, layout=None):
    ...
    log.info("Tuned aten._int_mm: m=%s, n=%s, k=%s, layout=%s", m, n, k, layout)
...
def tuned_addmm(inp, mat1, mat2, *, alpha=1, beta=1, layout=None):
    ...
    log.info("Tuned aten.addmm: m=%s, n=%s, k=%s, layout=%s", m, n, k, layout)
