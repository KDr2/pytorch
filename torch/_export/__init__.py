...
def _export_load_util(f: Union[str, os.PathLike, io.BytesIO],  extra_files: Optional[Dict[str, Any]] = None) -> ExportedProgram:
...
def load(
    ...
    *,
    ...
    artifact: SerializedArtifact = _export_load_util(f, expected_opset_version)
    if isinstance(f, (str, os.PathLike)):
        f = os.fspath(f)

    extra_files = extra_files or {}

    artifact = _export_load_util(f, extra_files)
