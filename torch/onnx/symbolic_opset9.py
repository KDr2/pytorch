...
__all__ = [
    ...
    "unsafe_split",
    "unsqueeze",
    "_unsupported_complex_operators",
    "_unsupported_complex_operators_noop",
    "unused",
    "var_mean",
    "var",
    "view_as",
...
@_beartype.beartype
def _unsupported_complex_operators_noop(g: jit_utils.GraphContext, input: _C.Value):
...
@_beartype.beartype
def _unsupported_complex_operators(g: jit_utils.GraphContext, input: _C.Value):
    # ONNX does not have operators to *directly* manipulate real/imaginary components
    # However, a few torch APIs (e.g. .tolist()) use complex operations when input is real,
    # which results in failures due to missing operators for complex numbers
    ...
    return _unsupported_complex_operators_noop(g, input)
