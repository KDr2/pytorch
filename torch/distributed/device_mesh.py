    ...
    class _MeshEnv:
        ...
        def create_child_mesh(
            ...
            if child_mesh_mappings:
                sub_mesh_local_rank = device_mesh.get_local_rank(mesh_dim_name)
                mesh_dim_key = f"{mesh_dim_name}_{sub_mesh_local_rank}"
            ...
            for local_rank_idx, mesh_1d in enumerate(pg_ranks_by_dim):
                sub_mesh = DeviceMesh(
                ...
                self.parent_to_child_mapping[device_mesh][
                    f"{mesh_dim_name}_{local_rank_idx}"
                ] = sub_mesh
