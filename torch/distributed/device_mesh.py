...
# We have to define it here instead of importing it from torch.distributed.
# Otherwise, we would have the following error message:
#     cannot import name 'is_available' from partially initialized module
#     'torch.distributed' (most likely due to a circular import)
# Also, we need this method to be private.
...
if _is_available():
    ...
    sys.modules["torch.distributed.device_mesh"].DeviceMesh = _DeviceMesh  # type: ignore[attr-defined]
    sys.modules["torch.distributed.device_mesh"].init_device_mesh = _init_device_mesh  # type: ignore[attr-defined]
