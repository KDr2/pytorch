...
def define_xnnpack(third_party, labels = [], XNNPACK_WINDOWS_AVX512F_ENABLED = False):
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("sse"),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("sse2"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("ssse3"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("sse41"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("avx"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("avx512vnnigfni"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("avx512vnni"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("avxvnni"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("f16c"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("fma3"),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("avx2"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("avx512f"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("avx512vbmi"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
    ...
    fb_xplat_cxx_library(
        ...
        srcs = select({
            ...
            "ovr_config//os:linux": prod_srcs_for_arch_wrapper("avx512skx"),
        }),
        headers = get_xnnpack_headers(),
        header_namespace = "",
        apple_sdks = (IOS, MACOSX),
