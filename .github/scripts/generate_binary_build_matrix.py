...
WHEEL_CONTAINER_IMAGES = {
    ...
    **{
    ...
    "xpu": f"pytorch/manylinux2_28-builder:xpu",
    "cpu": f"pytorch/manylinux2_28-builder:cpu",
    "cpu-aarch64": f"pytorch/manylinux2_28_aarch64-builder:cpu-aarch64",
...
LIBTORCH_CONTAINER_IMAGES: dict[str, str] = {
    **{
        gpu_arch: f"pytorch/libtorch-cxx11-builder:cuda{gpu_arch}"
        for gpu_arch in CUDA_ARCHES
    },
    **{
        gpu_arch: f"pytorch/libtorch-cxx11-builder:rocm{gpu_arch}"
        for gpu_arch in ROCM_ARCHES
    },
    "cpu": f"pytorch/libtorch-cxx11-builder:cpu",
}
